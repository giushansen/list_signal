defmodule LS.PipelineTest do
  ...
  describe "column count" do
    test "inserter has 68 columns matching schema (65 + http_fingerprint, pipeline_version, classification_source on 2026-09-06)" do
      ...
      # than trusted.
      assert length(LS.Cluster.Inserter.columns()) == 68
    end
  end
end

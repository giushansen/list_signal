defmodule LS.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      {DNSCluster, query: Application.get_env(:ls, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: LS.PubSub},
      # Start a worker by calling: LS.Worker.start_link(arg)
      # {LS.Worker, arg},
  ...
  def config_change(changed, _new, removed) do
    LSWeb.Endpoint.config_change(changed, removed)
    :ok
  end

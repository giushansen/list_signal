defmodule LS.Accounts.User do
  ...
  def subscribed?(%__MODULE__{stripe_subscription_id: sid}) when not is_nil(sid) and sid != "", do: true
  def subscribed?(_), do: false

  def effective_plan(%__MODULE__{} = user) do
    if subscribed?(user), do: user.plan, else: "free"
  end
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, LS.Repo)
  ...
  """
  def valid_password?(%LS.Accounts.User{hashed_password: hashed_password}, password)
